...
RSpec.describe Api::TasksController, type: :controller do
	...
	describe 'GET #index' do
		...
		it 'returns all tasks for the project' do
			task1 = create(:task, project: project, name: 'Task 1', description: 'Description 1')
			task2 = create(:task, project: project, name: 'Task 2', description: 'Description 2')
	...
	describe 'GET #show' do
		...
		it 'renders JSON with the task details' do
			task = create(:task, project: project, name: 'Test Task', description: 'Test Description')
			get :show, params: { project_id: project.id, id: task.id }
	...
	describe 'GET #tasks_by_status' do
		...
		it 'returns tasks with the required status' do
			task1 = create(:task, project: project, status: 0)
			task2 = create(:task, project: project, status: 1)
