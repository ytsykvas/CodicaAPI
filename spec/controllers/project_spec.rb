...
RSpec.describe Api::ProjectsController, type: :controller do
	...
	describe 'GET #index' do
		...
		it 'returns all projects' do
			project1 = create(:project, user: user, name: 'Project 1', description: 'Description 1')
			project2 = create(:project, user: user, name: 'Project 2', description: 'Description 2')
		...
		it 'returns all projects with included tasks' do
			project = create(:project, user: user, name: 'Project 1', description: 'Description 1')
			task = create(:task, name: 'Task 1', project: project)
	...
	describe 'GET #show' do
		...
		it 'renders JSON with the project details' do
			project = create(:project, user: user, name: 'Test Project', description: 'Test Description')
			get :show, params: { id: project.id }
	...
	describe 'PUT #update' do
		...
		it 'updates the requested project' do
			project = create(:project, user: user, name: 'Old Project', description: 'Old Description')
		...
		it 'returns errors for invalid project update' do
			project = create(:project, user: user, name: 'Existing Project', description: 'Existing Description')
